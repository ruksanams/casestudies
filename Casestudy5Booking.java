...
public class Casestudy5Booking 
{
		...
		int r;
		String op1,op2,op3;
		Casestudy52Booking c[]=new Casestudy52Booking[20];
		Casestudy51Booking d[]=new Casestudy51Booking[20];
		int i=0,s=101,k=0,j;
		int id=1;
		do {
		...
		case 2:System.out.println("View all bookings:");
		       ...
		       for(j=0;j<i;j++)
		       {
		        if(d[j].date.isAfter(sdate.minusDays(1))&&d[j].date.isBefore(edate.plusDays(1)))
		         {
		           d[j].viewbook();
		         }
		       }
